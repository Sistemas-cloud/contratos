...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
				...
				$curp = $row['curp'];
				$fecha_inicio = $row['fecha_inicio_esc'];
				$fecha_termino = $row['fecha_termino_esc'];
...
<body>
    ...
    <h2>Bienvenido, <?php echo $_SESSION['user']; ?> 👋</h2>
        ...
        <div id="formulario">
        <form method="POST" action="actualizarHora.php" onsubmit="return validarFormulario()">
        <div class="form-group">
                    ...
                    <input type="date" id="fechaInicioEsc" name="fechaInicioEsc" value="<?php echo htmlspecialchars($fecha_inicio); ?>">
                    <label for="fechaTerminoEsc">Fecha de Termino Ciclo Escolar</label>
                    <input type="date" id="fechaTerminoEsc" name="fechaTerminoEsc" value="<?php echo htmlspecialchars($fecha_termino); ?>">
                    <label for="fechaContrato_hora">Fecha de contrato</label>
                    <input type="date" id="fechaContrato_hora" name="fechaContrato_hora" value="<?php echo htmlspecialchars($fecha_contrato); ?>">
                    ...
                    <input type="time" id="horaEntrada_hora" name="horaEntrada_hora" value="<?php echo htmlspecialchars($hora_entrada); ?>">
                    <label for="horaSalida_hora">Horario de salida</label>
                    <input type="time" id="horaSalida_hora" name="horaSalida_hora" value="<?php echo htmlspecialchars($hora_salida); ?>">
                    <label for="costoHora">Costo por hora</label>
                    <input type="text" id="costoHora" name="costoHora" value="<?php echo htmlspecialchars($costo_hora); ?>">
                <h3>Beneficiarios</h3>
                <div class="form-group">
