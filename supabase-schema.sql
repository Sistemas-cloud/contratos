...
CREATE TABLE usuarios (
    ...
    usuario_password VARCHAR(255) NOT NULL, -- Se recomienda usar hash en producción
    usuario_nombre VARCHAR(100) NOT NULL,
    usuario_app VARCHAR(100), -- Apellido Paterno
    usuario_apm VARCHAR(100), -- Apellido Materno
...
CREATE TABLE contrato_determinado (
    ...
    dias TEXT NOT NULL, -- Días de trabajo separados por comas
    ...
    -- Metadata
    nivel INTEGER NOT NULL DEFAULT 1,
    nombre_act VARCHAR(255), -- Nombre de quien actualiza
...
-- Tabla de contratos por hora (Tiempo Determinado por Hora)
CREATE TABLE contrato_hora (
    ...
    domicilio TEXT NOT NULL,
    curp VARCHAR(18) NOT NULL,
    fecha_inicio_esc DATE NOT NULL, -- Fecha inicio ciclo escolar
    fecha_termino_esc DATE NOT NULL, -- Fecha término ciclo escolar
    fecha_contrato DATE NOT NULL,
    dias TEXT NOT NULL, -- Días de trabajo separados por comas
    hora_entrada TIME NOT NULL,
    hora_salida TIME NOT NULL,
...
-- Políticas para usuarios (solo pueden ver y editar su propio usuario)
...
VALUES ('admin', 'admin123', 'Administrador', 'Sistema', '', 2);

-- Usuario normal de ejemplo
-- Contraseña: user123
INSERT INTO usuarios (usuario_username, usuario_password, usuario_nombre, usuario_app, usuario_apm, nivel)
VALUES ('user1', 'user123', 'Usuario', 'Demo', '', 1);

-- =====================================================
-- VISTAS ÚTILES
-- =====================================================

-- Vista para obtener contratos con información del creador
